...
### Trabajo final
Carlos: Web, Poster, src, Data, Notebooks, Presentacion.
Rodri: Web, src, Notebooks, Data, Presentacion, configuracion proyecto.
Adrian: Web, Notebooks, src, docker, video, Configuracion proyecto.