...
### Deveres
crear en src un codigo que al darle play y se descarga el precio en tiempo real de la accion del sp500(etf),de cada empresa(500) en data en como lo queramos (json)