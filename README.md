...
3ºOrden de Ejecución:
    ...
    3.4º Se descargan y generan los datos (json_sp500.json y json_ibex35.json) ejecutando los scripts de src/.
...
Los datos (json_sp500.json y json_ibex35.json) no se suben a git porque pesan mucho. Se descargan y generan dentro del contenedor durante el build, por eso el primer "docker build" tarda un rato.